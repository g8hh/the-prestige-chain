...
function getChangeLogText(){
	...
	let final7 = [part69, part68, part67, part66, part65, part64, part63, part62, part61]
	let final8 = []

	let start = [["Hold Shift to see the full changelog!", shiftDown ? "" : "Currrently showing the 10 most recent entries", ""]]
	let end = final8.concat(final7).concat(final6).concat(final5).concat(final4).concat(final3).concat(final2).concat(final1)

	if (!shiftDown) return start.concat(end.slice(0, 10))
