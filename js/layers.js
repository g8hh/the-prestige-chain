...
addLayer("a", {
        ...
        canReset(){
                return this.getResetGain().gt(0) && player.a.time >= 5 && !hasUpgrade("a", 23)
        },
        upgrades: {
                rows: 5,
                cols: 5,
                        ...
                        content: ["main-display",
                                ...
                                ["display-text",
                                        function() {
                                                ...
                                                return "There is a five second cooldown for prestiging (" + format(Math.max(0, 5-player.a.time)) + ")" 
                                        },
                                        //{"font-size": "20px"}
                                ],
                                "blank", 
        ...
        doReset(layer){
                ...
                //buyables
                let resetBuyables = [11, 12, 13, 21, 22, 23, 31, 32]
                        ...
                        content: ["main-display",
                                ...
                                ["display-text",
                                        function() {
                                                ...
                                                return "There is a five second cooldown for prestiging (" + format(Math.max(0, 5-player.b.time)) + ")" 
                                        },
                                        //{"font-size": "20px"}
                                ],
                                "blank", 
...
addLayer("c", {
        ...
        upgrades:{
                ...
                15: {
                        title: "Copyright",
                        description: "Each Bacteria buyable gives a free <b>Based</b> level and keep the fourth row of Bacteria upgrades",
