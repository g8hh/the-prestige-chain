...
addLayer("a", {
        ...
        canReset(){
                return this.getResetGain().gt(0) && player.a.time >= 5
        },
        upgrades: {
                rows: 5,
                cols: 5,
...
addLayer("b", {
        ...
        canReset(){
                return this.getResetGain().gt(0) && player.b.time >= 5
        },
        upgrades: {
                rows: 5,
                cols: 5,
...
addLayer("c", {
        ...
        canReset(){
                return this.getResetGain().gt(0) && player.c.time >= 5
        },
        upgrades:{
                rows: 5,
                cols: 5,
